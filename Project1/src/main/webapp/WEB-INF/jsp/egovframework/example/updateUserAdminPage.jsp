...
<link rel="stylesheet" href="<c:url value="/css/egovframework/admin/updateUserAdminPage.css"/>"/>
	...
	<div class="main_div">
		...
		<div class="main_board_content">
			...
			<form id="form" class="update_form">
				...
				<span class="form_header_label">PASSWORD</span> <input type="text" name="password" id="password" value="<c:out value="${user.getPassword()}"/>" /><br>
...
<script>
	...
	cancelBtn.addEventListener("click", () => {
		location.href = "<c:url value="/admin/home.do"/>"
	});
